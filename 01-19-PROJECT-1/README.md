...
1. GitHub не позволяет выложить в репозиторий датасет, размер которого превышает
25 Мб. Файл с данными весит более 450 Мб. Поэтому надо добавить название файла с
данными в файл `.gitignore`, чтобы сделать `push` своего проекта на GitHub.
Выложить файл с данными на другие сервисы для хранения, в файле для описания
проекта `README.md` или в самом ноутбуке прикрепить ссылку на данные.
